    ...
    <>
      <div className='min-h-[150px] bg-[#FFFFFF] rounded-lg flex p-4 gap-4'>
        <form className='flex w-full gap-4' onSubmit={(e)=>{}}>
          <textarea name="reply" id="reply" placeholder='Add a comment...' className='rounded-lg w-[80%] border-[#E8E9ED] border-2 p-2 px-6 focus:border-[#2124B1] cursor-pointer' onChange={(e)=>{}}></textarea>
